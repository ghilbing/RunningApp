...
import com.hilbing.runningapp.utils.Constants.KEY_FIRST_TIME_TOGGLE
import com.hilbing.runningapp.utils.Constants.KEY_NAME
import com.hilbing.runningapp.utils.Constants.KEY_WEIGHT
import com.hilbing.runningapp.utils.Constants.RUNNING_DATABASE_NAME
import com.hilbing.runningapp.utils.Constants.SHARED_PREFERENCES_NAME
...
object AppModule {
    ...
    @Singleton
    @Provides
    fun provideWeight(sharedPreferences: SharedPreferences) = sharedPreferences.getFloat(KEY_WEIGHT, 52f)
